...
public class Store extends Frame{ //상점
	...
	public boolean itemProBuy1,itemProBuy2, itemProBuy3 = false;
	...
	public void initializeComponents() {
        ...
        // 현재 사용자 코인 label
        JLabel itemcoinLabel = new JLabel("0"); // 텍스트필드 초기화
        ...
        hammerItem.addMouseListener(new MouseAdapter() { // 닫기 버튼 이벤트 
      	...
      	background.add(hammerItem);
       	...
       	// 벌칙 두더지
      	JButton molelosing = new JButton(new ImageIcon(Main.class.getResource(IMAGE_PATH + "moleButtonGameMinus.png")));
      	molelosing.setBounds(400, 420, 90, 120); //버튼 위치
      	molelosing.setBorderPainted(false); // 버튼 테두리 설정
      	molelosing.setContentAreaFilled(false); // 버튼 영역 배경 표시 설정
      	molelosing.setFocusPainted(false); //포커스 표시 설정
      	...
      	moleDouble.addMouseListener(new MouseAdapter() { // 닫기 버튼 이벤트 
       	...
       	// 알록달록 두더지
      	JButton MoleRainbow = new JButton(new ImageIcon(Main.class.getResource(IMAGE_PATH + "rainbowMoleButton.png")));
      	MoleRainbow.setBounds(800, 420, 90, 120); //버튼 위치
      	MoleRainbow.setBorderPainted(false); // 버튼 테두리 설정
      	MoleRainbow.setContentAreaFilled(false); // 버튼 영역 배경 표시 설정
      	MoleRainbow.setFocusPainted(false); //포커스 표시 설정
      	MoleRainbow.addMouseListener(new MouseAdapter() { // 닫기 버튼 이벤트 
       	...
       	storeOkButton.addMouseListener(new MouseAdapter() { // 닫기 버튼 이벤트 
			...
			public void mousePressed(MouseEvent e) {//마우스를 눌렀을 때
		        ...
		        storeCancelButton.setVisible(false); // 구매 버튼 보이게
