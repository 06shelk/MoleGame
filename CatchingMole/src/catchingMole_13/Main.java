...
public class Main extends Frame { // 게임 시작 화면
	//버튼 이미지 저장
	private ImageIcon yesbuttonImage = (new ImageIcon(Main.class.getResource("../images/yesButton.png"))); // 네 이미지 클릭
	private ImageIcon yesbuttonEnteredImage = (new ImageIcon(Main.class.getResource("../images/yesButtonEntered.png"))); // 네 이미지 클릭
	private ImageIcon nobuttonImage = (new ImageIcon(Main.class.getResource("../images/noButton.png"))); // 아니오 이미지 클릭
	private ImageIcon nobuttonEnteredImage = (new ImageIcon(Main.class.getResource("../images/noButtonEntered.png"))); // 아니오 이미지 클릭
	public Main() {
    	//초기화 코드 불러오기
    ...
    public void initializeComponents() {
        ...
        //네 버튼 설정
        JButton yesButton = new JButton(new ImageIcon(Main.class.getResource("../images/yesButton.png")));
      ...
      //아니요 버튼 설정
        JButton noButton = new JButton(new ImageIcon(Main.class.getResource("../images/noButton.png")));
