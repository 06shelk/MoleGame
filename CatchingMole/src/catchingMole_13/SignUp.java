...
public class SignUp extends Frame{ //회원가입
	...
	private ImageIcon signupButtonImage = (new ImageIcon(Main.class.getResource("../images/signupButton.png")));// 로그아웃 이미지 기본
	...
	public void initializeComponents() {
		//배경 설정
        background = new JLabel(new ImageIcon(Main.class.getResource("../images/signupScreen.png"))); // 배경이미지
		...
		JButton signupButton = new JButton(new ImageIcon(Main.class.getResource("../images/signupButton.png")));
