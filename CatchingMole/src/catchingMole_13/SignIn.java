...
public class SignIn extends Frame{ //로그인
	...
	public void initializeComponents() {
		//배경 설정
        background = new JLabel(new ImageIcon(Main.class.getResource("../images/loginScreen.png"))); // 배경이미지
		...
		JButton loginbutton = new JButton(new ImageIcon(Main.class.getResource("../images/loginbutton.png")));
