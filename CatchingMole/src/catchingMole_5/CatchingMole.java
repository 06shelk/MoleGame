...
public class CatchingMole extends JFrame {
	...
	//게임 두더지 이미지
	private ImageIcon moleButtonGameBasicImage = (new ImageIcon(Main.class.getResource("../images/moleButtonBasic.png")));// 두더지 이미지 기본
	...
	private JButton moleGameBasicButton = new JButton(moleButtonBasicImage); //시작 버튼
	private JButton moleGameDoubleButton = new JButton(moleButtonGameDoubleImage); //시작 버튼
	private JButton moleGameMinusButton = new JButton(moleButtonGameMinusImage); //시작 버튼
